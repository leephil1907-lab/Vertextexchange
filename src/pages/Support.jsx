...
const FAQ = [
  ["How does trading work?", "Orders execute against live CoinGecko market data on your funded wallet — spot, futures with real liquidation math, swaps and DCA bots. A demo session with separate practice funds is available in the terminal via the LIVE/DEMO switch."],
  ["How do deposits and withdrawals work?", "Deposit: pick a receiving wallet on the Funding page, send your crypto on the exact network shown, then submit the amount and transaction reference. An admin verifies the transfer manually and credits your wallet — you get a notification and email. Withdrawal: enter your address, network and amount; funds are held, verified, then paid out manually to your address. Declined requests refund automatically."],
  ...
  ["Why is my chart not updating tick-by-tick?", "The CoinGecko API polls rather than streams. Between polls the chart holds the last real price — prices are never fabricated."],
