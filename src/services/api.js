...
export const api = {
  ...
  fundingRequest: (payload) => call("/api/funding/request", { method: "POST", body: payload }),
  ...
  adminPaymentMethods: () => call("/api/admin/payment-methods"),
  adminAddPaymentMethod: (payload) => call("/api/admin/payment-methods", { method: "POST", body: payload }),
  adminUpdatePaymentMethod: (id, payload) => call(`/api/admin/payment-methods/${id}`, { method: "PATCH", body: payload }),
  adminDeletePaymentMethod: (id) => call(`/api/admin/payment-methods/${id}`, { method: "DELETE" }),
